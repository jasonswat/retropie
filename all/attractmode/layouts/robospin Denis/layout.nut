...
class UserConfig {
   </ label="Select background art", help="Choice of blue, retro , den or flyer for background", options="blue,retro,den1,den2,den3,den4,flyer", order=1 /> enable_bg="blue";   
...
{
local b_art = fe.add_image("bkg2.png", 0, 0, flw, flh );
b_art.alpha=255;
}

if ( my_config["enable_bg"] == "den1") 
{
local b_art = fe.add_image("bkg3.png", 0, 0, flw, flh );
b_art.alpha=255;
}

if ( my_config["enable_bg"] == "den2") 
{
local b_art = fe.add_image("bkg4.png", 0, 0, flw, flh );
b_art.alpha=255;
}

if ( my_config["enable_bg"] == "den3") 
{
local b_art = fe.add_image("bkg5.png", 0, 0, flw, flh );
b_art.alpha=255;
}

if ( my_config["enable_bg"] == "den4") 
{
local b_art = fe.add_image("bkg6.png", 0, 0, flw, flh );
b_art.alpha=255;
}
